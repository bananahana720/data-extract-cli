...
# Reference: docs/ux-design-specification.md Section 5.1 Journey 3
# -----------------------------------------------------------------------------
...
class TestJourney3SemanticAnalysis:
    ...
    def test_pipeline_stages_display(self, tmux_session: TmuxSession) -> None:
        ...
        Reference: docs/ux-design-specification.md - Journey 3, Step 2
        """
    ...
    def test_suggestions_displayed(self, tmux_session: TmuxSession) -> None:
        ...
        Reference: docs/ux-design-specification.md - Journey 3, Step 3
        """
