...
def main():
    ...
    tests.append(
        test_hook(
            "bash_hook.py",
            {"tool_name": "Bash", "tool_input": {"command": "git add *.py"}},
            2,
    ...
    tests.append(
        test_hook(
            "bash_hook.py",
            {"tool_name": "Bash", "tool_input": {"command": "git grep 'pattern'"}},
            0,
    ...
    tests.append(
        test_hook(
            ...
            {"tool_name": "Read", "tool_input": {"file_path": "bash_hook.py"}},  # Small file
            0,
